import { AlertTriangle, Antenna, ChevronsRightLeft, GitBranch, UploadCloud } from "lucide-react";

export function VsCodeFooter() {

  return (
  <div className="w-full max-w-7xl bg-vs-footer text-white text-xs rounded-b-lg flex gap-1 items-center overflow-hidden"
    style={{
      gridArea: 'footer'
    }}
  >
